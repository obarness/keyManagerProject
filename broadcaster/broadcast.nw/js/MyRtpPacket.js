...
RtpPacket.prototype._init=function(options){
    ...
    var V = opts.V ? opts.V : 2, // version. always 2 for this RFC (2 bits)
        ...
        //added by Omer
        aesSequence = opts.aesSequence?opts.aesSequence:-1 //this should represent the id of aes key we are using for this packet. (8 bits)
...
*/
    ...
    header[11] = (SSRC & 0xFF);
    header[12] = (aesSequence);         //added by Omer
